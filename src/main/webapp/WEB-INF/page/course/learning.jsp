...
<head>
    ...
    <!--时间选择插件-->
    <link rel="stylesheet" href="${APP_PATH }/static/js/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css">
    <!--日期选择插件-->
    <link rel="stylesheet" href="${APP_PATH }/static/js/bootstrap-datepicker/bootstrap-datepicker3.min.css">
            ...
            <ul class="navbar-nav navbar-right" style="list-style: none;">
                ...
                <li class="dropdown dropdown-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li> <a href="${APP_PATH }/customer/updPassword"><i class="mdi mdi-lock-outline"></i> 修改密码</a> </li>
                        <li> <a href="person.html"><i class="mdi mdi-comment-alert-outline"></i> 系统通知 <span class="badge">4</span></a> </li>
            ...
            <div class="lyear-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav nav-subnav">
                            <a href="${APP_PATH }/customer/updPassword"><i class="mdi mdi-lock-outline"></i> 修改密码</a>

                        </li>
                        <li class="nav nav-subnav">
                            <a href="member.html"><i class="mdi mdi-currency-cny"></i> 会员中心</a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="active"> <a href="javascript:void(0)">学习中</a> </li>
                            <li> <a href="${APP_PATH }/course/learned">已学完</a> </li>
                        ...
                        <c:forEach items="${courseLearns}" var="courseLearn">
                            <div class="row">
                                <div class="col-lg-3" style="margin-top: 15px;margin-left: 20px;">
                                    <a href="${APP_PATH }/course/${courseLearn.course.courseId}" class="thumbnail">
                                        <img src="${APP_PATH }/static/img/${courseLearn.course.url}" alt="...">
                                ...
                                <div class="col-lg-2" style="margin-top: 65px;">
                                    <button class="btn btn-w-md btn-round btn-primary" onclick="window.location='${APP_PATH }/course/${courseLearn.course.courseId}'">继续学习</button>
                                </div>
                            </div>
                        </c:forEach>
                                ...
                                <nav>
                                    <ul class="pagination pagination-circle">
                                        <li class="${rowBounds.curPage==1?'disabled':null}">
                                            <a href="${APP_PATH }/course/learning?page=${rowBounds.curPage-1}">
                                                <span><i class="mdi mdi-chevron-left"></i></span>
                                            </a>
                                        </li>
                                        <c:forEach begin="1" end="${rowBounds.pages}" var="page">
                                            <li class="${rowBounds.curPage==page?'active':null}"><a href="${APP_PATH }/course/learning?page=${page}">${page}</a></li>
                                        </c:forEach>
...
<script type="text/javascript" src="${APP_PATH }/static/js/bootstrap-datetimepicker/moment.min.js"></script>
<script type="text/javascript" src="${APP_PATH }/static/js/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="${APP_PATH }/static/js/bootstrap-datetimepicker/locale/zh-cn.js"></script>
<!--日期选择插件-->
<script type="text/javascript" src="${APP_PATH }/static/js/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="${APP_PATH }/static/js/bootstrap-datepicker/locales/bootstrap-datepicker.zh-CN.min.js"></script>
