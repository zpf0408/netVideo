                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            ...
                            <li> <a href="${basePath }/course/learned">已学完</a> </li>
                        ...
                        <c:forEach items="${courseLearns}" var="courseLearn">
                            <div class="row">
                                ...
                                <div class="col-lg-2" style="margin-top: 65px;">
                                    <button class="btn btn-w-md btn-round btn-primary" onclick="window.location='${basePath }/course/${courseLearn.course.courseId}'">继续学习</button>
                                </div>
                            </div>
                        </c:forEach>
