            ...
            <ul class="navbar-nav navbar-right" style="list-style: none;">
                ...
                <li class="dropdown dropdown-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li> <a href="${APP_PATH }/course/learning"><i class="mdi mdi-comment-alert-outline"></i> 系统通知 <span class="badge">4</span></a>
                        </li>
        ...
        <div class="row" style="margin: 10px 20px;">
            <c:forEach items="${courses}" var="course">
                <div class="col-xs-6 col-md-3">
                    <a href="${APP_PATH }/course/${course.courseId}" class="thumbnail">
                    ...
                    <nav>
                        <ul class="pagination pagination-circle">
                            <li class="${rowBounds.curPage==1?'disabled':null}">
                                <a href="${APP_PATH }/course/courseDisplay/${courseType.typeId}?page=${rowBounds.curPage-1}">
                                    <span><i class="mdi mdi-chevron-left"></i></span>
                                </a>
                            </li>
                            <c:forEach begin="1" end="${rowBounds.pages}" var="page">
                                <li class="${rowBounds.curPage==page?'active':null}"><a href="${APP_PATH }/course/courseDisplay/${courseType.typeId}?page=${page}">${page}</a></li>
                            </c:forEach>
