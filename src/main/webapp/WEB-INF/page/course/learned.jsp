            ...
            <ul class="navbar-nav navbar-right" style="list-style: none;">
                ...
                <li class="dropdown dropdown-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li> <a href="${APP_PATH }/course/learning"><i class="mdi mdi-comment-alert-outline"></i> 系统通知 <span class="badge">4</span></a> </li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li> <a href="${APP_PATH}/course/learning">学习中</a> </li>
                        ...
                        <c:forEach items="${courseLearns}" var="courseLearn">
                            <div class="row">
                                ...
                                <div class="col-lg-2" style="margin-top: 65px;">
                                    <button class="btn btn-w-md btn-round btn-primary" onclick="window.location='${APP_PATH }/course/${courseLearn.course.courseId}'">查看课程</button>
                                </div>
                            </div>
                        </c:forEach>
                                ...
                                <nav>
                                    <ul class="pagination pagination-circle">
                                        <li class="${rowBounds.curPage==1?'disabled':null}">
                                            <a href="${APP_PATH }/course/learned?page=${rowBounds.curPage-1}">
                                                <span><i class="mdi mdi-chevron-left"></i></span>
                                            </a>
                                        </li>
                                        <c:forEach begin="1" end="${rowBounds.pages}" var="page">
                                            <li class="${rowBounds.curPage==page?'active':null}"><a href="${APP_PATH }/course/learned?page=${page}">${page}</a></li>
                                        </c:forEach>
