        ...
        <div class="col-lg-9">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#video">目录</a></li>
                    <li class="nav-item"><a href="${basePath}/comment/${course.courseId}">评价</a></li>
                        ...
                        <c:forEach items="${videos}" var="video" varStatus="i">
                            <a href="${basePath }/video/${video.videoId}">
                                <div class="row" style="height: 40px;">
                                    ...
                                    <c:choose>
                                        <c:when test="${video.isWatched =='1'}">
                                            <div class="col-lg-2" style="text-align: left;"><i
                                                    class="mdi mdi-checkbox-marked-circle"></i>&nbsp;&nbsp;&nbsp;任务${i.index+1}：
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="col-lg-2" style="text-align: left;"><i
                                                    class="mdi mdi-circle-outline"></i>&nbsp;&nbsp;&nbsp;任务${i.index+1}：
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                    ...
                                    <div class="col-lg-7">${video.videoName}</div>
                                    <div class="col-lg-2" style="text-align: center;"><i class="mdi mdi-file-video"></i></div>
                                </div>
                            </a>
                        </c:forEach>
                    </div>
