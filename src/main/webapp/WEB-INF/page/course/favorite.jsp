            ...
            <div class="lyear-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav nav-subnav">
                            <a href="${APP_PATH }/customer/retrievePwd"><i class="mdi mdi-lock-outline"></i> 修改密码</a>
                ...
                <div class="row" style="margin: 0px 30px;">
                    ...
                    <c:forEach items="${favorites}" var="favorite">
                        <div class="col-xs-6 col-md-3">
                            <a href="${APP_PATH }/course/${favorite.course.courseId}" class="thumbnail">
                                <img src="${APP_PATH }/static/img/${favorite.course.url}" alt="...">
